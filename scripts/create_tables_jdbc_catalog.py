#!/usr/bin/env python3
"""Create tables using JDBC catalog with SQLite (works with MinIO)."""
...
print("=" * 70)
print("CREATING TABLES WITH JDBC CATALOG + MINIO")
print("=" * 70)

# Create SQLite database for catalog metadata
db_path = "/tmp/iceberg_catalog.db"
if os.path.exists(db_path):
    os.remove(db_path)

print(f"\n[1/5] Using JDBC catalog with SQLite: {db_path}")

# Initialize JDBC catalog
try:
    ...
    print("✅ JDBC catalog initialized")
except Exception as e:
    print(f"❌ Failed to initialize JDBC catalog: {e}")
...
print("\n" + "=" * 70)
print("[5/5] ✅ TABLE CREATION COMPLETE WITH JDBC CATALOG")
print("=" * 70)
print(f"\nCatalog database: {db_path}")
