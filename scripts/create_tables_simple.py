#!/usr/bin/env python3
"""Create simple Iceberg tables without partitions using PyIceberg."""
...
try:
    ...
    data = pa.table({
        ...
        "created_date": [datetime(2024, 1, 1)] * 7,
    })
    table.append(data)
...
try:
    ...
    more_data = pa.table({
        ...
        "customer_id": [2, 3],
        "product_id": [104, 105],
        "order_date": [datetime(2024, 12, 6, 10, 0, 0), datetime(2024, 12, 6, 11, 0, 0)],
        "quantity": [1, 1],
        "amount": [299.99, 149.99],
        "status": ["completed", "completed"],
        "shipping_address": ["456 Oak Ave, Los Angeles, CA", "789 Pine Rd, Toronto, ON"],
    })
    table.append(more_data)
    print("  ✓ Created second snapshot")
